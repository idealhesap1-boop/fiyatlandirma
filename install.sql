...
INSERT INTO `oc_extension` (`extension`, `type`, `code`) VALUES ('component_product', 'module', 'component_product')
ON DUPLICATE KEY UPDATE `extension` = 'component_product';
...
INSERT INTO `oc_extension` (`extension`, `type`, `code`) VALUES ('component_total', 'total', 'component_total')
ON DUPLICATE KEY UPDATE `extension` = 'component_total';
