...
class Main extends \Opencart\System\Engine\Model {
    ...
    /**
     * Get component options and panel data for a product
     */
    public function getProductComponentPanel(int $product_id): array {
        ...
        // Get option values that have note_text (component values)
    ...
    /**
     * Get stock quantity for an option value (component)
     */
    public function getOptionValueStock(int $option_value_id): ?int {
        // OpenCart doesn't natively track option value stock
        // Return null to indicate stock checking not available
        return null;
    }
}
